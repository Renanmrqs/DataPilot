# Preferências de colaboração no DataPilot

Registradas a pedido de Renan em 2026-09-11 para orientar as próximas sessões.

- Este é um projeto pessoal de aprendizado e portfólio, feito nas horas vagas. O tempo disponível é limitado; uma sessão de cerca de cinco horas pode representar o fim de semana inteiro dedicado ao projeto.
- Renan já conhece fundamentos de Python e reconhece boa parte da sintaxe. Sua principal preocupação é desenvolver critérios para saber se o código e o projeto estão corretos, enquanto ainda está construindo essa experiência.
- Intercalar implementação pelo assistente com prática guiada: em alguns momentos entregar código explicado; em outros, deixar Renan escrever com pistas e revisar sua tentativa. Não adotar exclusivamente nenhum dos dois modos.
- Equilibrar avanço concreto e aprendizado. Não transformar toda etapa em exercício nem gastar a sessão decorando sintaxe ou reescrevendo o que já está pronto.
